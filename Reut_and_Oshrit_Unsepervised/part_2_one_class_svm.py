...
def hist_plot(scores, bins_num=30):
    plt.hist(scores, bins=bins_num, color='olive', alpha=0.7, edgecolor='black')
    ...
    plt.savefig(f'{out_dir}/histogram_anomalies_one_class_svm_1_std.pdf', bbox_inches="tight", pad_inches=0.2)
    plt.close()
